...
#[derive(Debug)]
pub struct RollupSuiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RollupSuiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RollupSuite processing");
    
    let mut processor = RollupSuiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RollupSuiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RollupSuiteProcessor::new(false);
